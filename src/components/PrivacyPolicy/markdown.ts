...
- __Application__ refers to TasteCraft, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TasteCraft.
...
- By email: tastecraft.info@gmail.com
