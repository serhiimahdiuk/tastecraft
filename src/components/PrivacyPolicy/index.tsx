...
export default () => {
  return (
    <div className="flex flex-col rounded-md backdrop-blur-md">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to TasteCraft, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to TasteCraft.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: tastecraft.info@gmail.com</li>
      </ul>
    </div>
  );
};
